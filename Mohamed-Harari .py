...
def omar():
       ...
       omar = requests.get("https://pastebin.com/MHi4gnYE").text
       if id in omar:
        print("\33[1;32m ﻞﻌﻔﻣ")
        pass
       else:
...

    ...
    AUTHOR    :   Mohammed Al Harari 
  FACEBOOK  :   https://www.facebook.com/profile.php?id=100002859408654
  GITHUB    :   Mohammed Al Harari 
  TELEGRAM  :   @xst7s
\033[1;91m=========================================================="""
